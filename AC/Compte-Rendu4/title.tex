...
\subsection{Résultats}
L'algorithme génétique donne rapidement de bons résultats (voir le meilleur résultat) pour un nombre assez faible de ville.
TODO amélioration, include graphics
